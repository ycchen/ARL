...
$ rails g scaffold location name:string latitude:string longitude:string
...
15. Added "cancan" gem to handle user roles: cancan expect a curent_user method to exist in the controller, so we need to setup some authentication (such as Devise)
